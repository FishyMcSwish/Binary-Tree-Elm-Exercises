...
var _user$project$Main$foldSum = function (tree) {
	return A3(
...
var _user$project$Main$foldFlatten = function (tree) {
	return A3(
		_user$project$Main$fold,
		F2(
			function (x, y) {
...
var _user$project$Main$foldContains = F2(
	function (tree, item) {
		return A3(
			_user$project$Main$fold,
			function (_p2) {
					...
					_0: A2(
						...
						function (_p1) {
							return A2(
								...
								_user$project$Main$flatten(_user$project$Main$mytesttree));
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					_elm_community$elm_test$Test$describe,
					'some tests for contains',
					{
						ctor: '::',
						_0: A2(
							_elm_community$elm_test$Test$test,
							'when the tree is empty it should return false',
							function (_p2) {
								return A2(
									_elm_community$elm_test$Expect$equal,
									false,
									A2(_user$project$Main$contains, _user$project$Main$empty, 1));
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_community$elm_test$Test$test,
								'find the thing in a singleton',
								function (_p3) {
									return A2(
										_elm_community$elm_test$Expect$equal,
										true,
										A2(
											_user$project$Main$contains,
											_user$project$Main$singleton(1),
											1));
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_community$elm_test$Test$test,
									'find the thing in a bigger tree',
									function (_p4) {
										return A2(
											_elm_community$elm_test$Expect$equal,
											true,
											A2(_user$project$Main$contains, _user$project$Main$mytesttree, 3));
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										function (_p5) {
											return A2(
												_elm_community$elm_test$Expect$equal,
												false,
												A2(_user$project$Main$contains, _user$project$Main$mytesttree, 10));
										}),
									_1: {ctor: '[]'}
								}
							}
				...
				_1: {
					...
					_0: A2(
						...
						'tests for fold',
						{
							...
							_0: A2(
								_elm_community$elm_test$Test$test,
								'just return starting value when tree is empty',
								function (_p6) {
									return A2(
										_elm_community$elm_test$Expect$equal,
										0,
							...
							_1: {
								...
								_0: A2(
									_elm_community$elm_test$Test$test,
									'test folding: adding a singleton',
									function (_p7) {
										return A2(
											_elm_community$elm_test$Expect$equal,
											4,
											A3(
												...
												0,
												_user$project$Main$singleton(4)));
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_community$elm_test$Test$test,
										'test folding: adding a larger tree',
										function (_p8) {
											return A2(
												_elm_community$elm_test$Expect$equal,
												28,
									...
									_0: A2(
										...
										function (_p10) {
											return A2(
												...
												_user$project$Main$foldFlatten(_user$project$Main$mytesttree));
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
										...
										_0: A2(
											...
											function (_p11) {
												return A2(
													_elm_community$elm_test$Expect$equal,
													false,
													A2(_user$project$Main$foldContains, _user$project$Main$empty, 1));
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												function (_p12) {
													return A2(
														...
														true,
														A2(
															_user$project$Main$foldContains,
															_user$project$Main$singleton(1),
															1));
												}),
											_1: {
												...
												_0: A2(
													...
													function (_p13) {
														return A2(
															_elm_community$elm_test$Expect$equal,
															true,
															A2(_user$project$Main$foldContains, _user$project$Main$mytesttree, 3));
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														function (_p14) {
															return A2(
																_elm_community$elm_test$Expect$equal,
																false,
																A2(_user$project$Main$foldContains, _user$project$Main$mytesttree, 10));
														}),
													_1: {ctor: '[]'}
												}
											}
								...
								_1: {
									...
									_0: A2(
										_elm_community$elm_test$Test$describe,
										'tests for different traversal methods',
										{
											ctor: '::',
											_0: A2(
												_elm_community$elm_test$Test$test,
